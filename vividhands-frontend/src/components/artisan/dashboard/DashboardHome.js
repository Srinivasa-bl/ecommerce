...
import artisanDashboardService from "../../services/artisanDashboardService"; // Adjust the import path as necessary
...
const DashboardHome = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        const response = await artisanDashboardService.getDashboardStats();
